...
}d.LINKS+=((d.LINK_UP&&d.LINK_UP!=document.URL)?'<a href="'+d.LINK_UP+'">PREV</a> / ':"")+((d.LINK_HOME&&d.LINK_HOME!=document.URL)?'<a href="'+d.LINK_HOME+'">NEXT</a> / ':"")+'<a href="javascript:org_html_manager.showHelp();">HELP</a> / ';
